...
class Playlists{
  ...
  Playlists({required this.playlistname,required this.playlistsongs});
}
@HiveType(typeId: 4)
class RecentSongs{
  @HiveField(0)
  ...
  RecentSongs({required this.songname,required this.artist,required this.id,required this.duration,required this.songurl,required this.count});
